...
<h1>Los datos se registraron con éxito pulse aceptar para continuar</h1>
<div class="input-box">
<button type="submit" name="x" class="btn"><img id="image" src="img/aceptar.png" alt="Image 4" width="70px" height="70px"></button>
</div>
</form>
</div>
</body>
